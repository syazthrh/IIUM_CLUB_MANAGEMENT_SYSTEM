...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 30, 2024 at 10:12 AM
...
-- Functions
--
CREATE DEFINER=`root`@`localhost` FUNCTION `GetClubMemberCount` (`club_id` INT) RETURNS INT(11)  BEGIN
    DECLARE mainboard_count INT;
    
    SELECT COUNT(*) INTO mainboard_count
    FROM mainboard
    WHERE ClubID = club_id;

    RETURN mainboard_count;
END$$

CREATE DEFINER=`root`@`localhost` FUNCTION `MAINBOARD_RETIRE` (`JoinDate` DATE) RETURNS DATE  BEGIN
    DECLARE retire_date DATE;

    SET retire_date = DATE_ADD(JoinDate, INTERVAL 6 MONTH);
...
(1234, 'Future Leaders 3.0', 'Diyana binti Ahmad', 'diyana@gmail.com', '011-2314132', 'ECONS', 'Secretary'),
(1234567, 'JASA\'s Mensino Little Explorers', 'John Doe', 'john.doe@example.com', '1234567890', 'KICT', 'catering'),
(2013212, 'Future Leaders 3.0', 'Tengku Normariah binti Tengku Ahmad', 'mariah@gmail.com', '0182826834', 'KOE', 'Dakwah and Ibadah'),
...
(3012345, 'New Program', 'New Member', 'newmember@gmail.com', '6012345678', 'New Kulliyyah', 'New Committee'),
